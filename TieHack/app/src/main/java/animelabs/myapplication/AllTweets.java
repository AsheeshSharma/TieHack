 ...
 */
public class AllTweets extends ListActivity {
    ...
    class LoadAllMessages extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllTweets.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try{
                ...
                HttpPost httppost = new HttpPost("http://tiehbackrevieww.co.nf/alltweets.php");
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            AllTweets.this, matchFixtureList,
                            R.layout.templa, new String[] { TAG_TWEETS,
                            TAG_TEXT,TAG_TID},
